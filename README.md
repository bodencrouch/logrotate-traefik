...
[![Docker Build](https://github.com/bodencrouch/logrotate-traefik/actions/workflows/docker-build.yml/badge.svg)](https://github.com/bodencrouch/logrotate-traefik/actions)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/bodencrouch/logrotate-traefik.git
...
- **Issues**: [GitHub Issues](https://github.com/bodencrouch/logrotate-traefik/issues)
- **Discussions**: [GitHub Discussions](https://github.com/bodencrouch/logrotate-traefik/discussions)
- **Documentation**: [Wiki](https://github.com/bodencrouch/logrotate-traefik/wiki)
